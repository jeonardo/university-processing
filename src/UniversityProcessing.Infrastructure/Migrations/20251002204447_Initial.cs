    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    university_position_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    faculty_id = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    period_id = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    name = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    diploma_process_id = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    committee_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    diploma_process_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    period_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    diploma_process_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    committee_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    diploma_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    defense_session_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    department_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    faculty_id = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
