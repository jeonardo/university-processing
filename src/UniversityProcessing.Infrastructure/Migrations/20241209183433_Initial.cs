        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    short_name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    required_titles = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    study_period_from = table.Column<DateTime>(type: "TEXT", nullable: false),
                    study_period_to = table.Column<DateTime>(type: "TEXT", nullable: false),
                    active_from = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_groups_diploma_periods_diploma_period_id",
                        column: x => x.diploma_period_id,
                        principalTable: "diploma_periods",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_groups_diploma_period_id",
                table: "groups",
                column: "diploma_period_id");
