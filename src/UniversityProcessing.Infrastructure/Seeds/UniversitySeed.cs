...
{
    public class UniversitySeed(IUnitOfWork unitOfWork)
    {
        ...
        public void Seed()
        {
            ...
            var bntu_faculty_fitr_sp3 = AddSpecialty("Автоматизированные электроприводы", "Short", "6-05-0713-04", bntu_faculty_fitr);
        ...
        private StudyGroupEntity AddStudyGroup(string groupNumber, SpecialtyEntity specialty, DateOnly startDate, DateOnly endDate)
        {
        ...
        private EmployeeEntity AddEmployee(string username, UniversityEntity employer, UniversityPositionEntity position, DepartmentEntity? department = null)
        {
