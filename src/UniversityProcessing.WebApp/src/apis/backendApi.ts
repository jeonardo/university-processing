...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    getApiV1DepartmentGetById: build.query<
      GetApiV1DepartmentGetByIdApiResponse,
      GetApiV1DepartmentGetByIdApiArg
    >({
      query: (queryArg) => ({ url: `/api/v1/Department/Get/${queryArg.id}` }),
    }),
    getApiV1DepartmentList: build.query<
      GetApiV1DepartmentListApiResponse,
      GetApiV1DepartmentListApiArg
    >({
      query: (queryArg) => ({
    ...
    postApiV1DepartmentCreate: build.mutation<
      PostApiV1DepartmentCreateApiResponse,
      PostApiV1DepartmentCreateApiArg
    >({
      query: (queryArg) => ({
        ...
        params: {
          Name: queryArg.name,
          ShortName: queryArg.shortName,
          FacultyId: queryArg.facultyId,
        },
      }),
    }),
    deleteApiV1DepartmentDelete: build.mutation<
      DeleteApiV1DepartmentDeleteApiResponse,
      DeleteApiV1DepartmentDeleteApiArg
    >({
      query: (queryArg) => ({
    ...
    getApiV1FacultyGetById: build.query<
      GetApiV1FacultyGetByIdApiResponse,
      GetApiV1FacultyGetByIdApiArg
    >({
      query: (queryArg) => ({ url: `/api/v1/Faculty/Get/${queryArg.id}` }),
    }),
    getApiV1FacultyList: build.query<
      GetApiV1FacultyListApiResponse,
      GetApiV1FacultyListApiArg
    >({
      query: (queryArg) => ({
    ...
    postApiV1FacultyCreate: build.mutation<
      PostApiV1FacultyCreateApiResponse,
      PostApiV1FacultyCreateApiArg
    >({
      query: (queryArg) => ({
        ...
        params: {
          Name: queryArg.name,
          ShortName: queryArg.shortName,
          UniversityId: queryArg.universityId,
        },
      }),
    }),
    deleteApiV1FacultyDelete: build.mutation<
      DeleteApiV1FacultyDeleteApiResponse,
      DeleteApiV1FacultyDeleteApiArg
    >({
      query: (queryArg) => ({
    ...
    getApiV1GroupGetById: build.query<
      GetApiV1GroupGetByIdApiResponse,
      GetApiV1GroupGetByIdApiArg
    >({
      query: (queryArg) => ({ url: `/api/v1/Group/Get/${queryArg.id}` }),
    }),
    getApiV1GroupList: build.query<
      GetApiV1GroupListApiResponse,
      GetApiV1GroupListApiArg
    >({
      query: (queryArg) => ({
    ...
    postApiV1GroupCreate: build.mutation<
      PostApiV1GroupCreateApiResponse,
      PostApiV1GroupCreateApiArg
    >({
      query: (queryArg) => ({
    ...
    deleteApiV1GroupDelete: build.mutation<
      DeleteApiV1GroupDeleteApiResponse,
      DeleteApiV1GroupDeleteApiArg
    >({
      query: (queryArg) => ({
        url: `/api/v1/Group/Delete`,
        method: "DELETE",
        body: queryArg.groupDeleteRequestDto,
      }),
    }),
    ...
    postApiV1IdentityRegister: build.mutation<
      PostApiV1IdentityRegisterApiResponse,
      PostApiV1IdentityRegisterApiArg
    >({
      query: (queryArg) => ({
    ...
    getApiV1IdentityLogout: build.query<
      GetApiV1IdentityLogoutApiResponse,
      GetApiV1IdentityLogoutApiArg
    >({
    ...
    getApiV1SpecialtyGetById: build.query<
      GetApiV1SpecialtyGetByIdApiResponse,
      GetApiV1SpecialtyGetByIdApiArg
    >({
      query: (queryArg) => ({ url: `/api/v1/Specialty/Get/${queryArg.id}` }),
    }),
    getApiV1SpecialtyList: build.query<
      GetApiV1SpecialtyListApiResponse,
      GetApiV1SpecialtyListApiArg
    >({
      query: (queryArg) => ({
    ...
    postApiV1SpecialtyCreate: build.mutation<
      PostApiV1SpecialtyCreateApiResponse,
      PostApiV1SpecialtyCreateApiArg
    >({
      query: (queryArg) => ({
    ...
    deleteApiV1SpecialtyDelete: build.mutation<
      DeleteApiV1SpecialtyDeleteApiResponse,
      DeleteApiV1SpecialtyDeleteApiArg
    >({
      query: (queryArg) => ({
    ...
    getApiV1UniversityGetById: build.query<
      GetApiV1UniversityGetByIdApiResponse,
      GetApiV1UniversityGetByIdApiArg
    >({
      query: (queryArg) => ({ url: `/api/v1/University/Get/${queryArg.id}` }),
    }),
    getApiV1UniversityList: build.query<
      GetApiV1UniversityListApiResponse,
      GetApiV1UniversityListApiArg
    >({
      query: (queryArg) => ({
    ...
    postApiV1UniversityCreate: build.mutation<
      PostApiV1UniversityCreateApiResponse,
      PostApiV1UniversityCreateApiArg
    >({
      query: (queryArg) => ({
    ...
    deleteApiV1UniversityDelete: build.mutation<
      DeleteApiV1UniversityDeleteApiResponse,
      DeleteApiV1UniversityDeleteApiArg
    >({
      query: (queryArg) => ({
    ...
    getApiV1UniversityPositionGetById: build.query<
      GetApiV1UniversityPositionGetByIdApiResponse,
      GetApiV1UniversityPositionGetByIdApiArg
    >({
      query: (queryArg) => ({
        url: `/api/v1/UniversityPosition/Get/${queryArg.id}`,
      }),
    }),
    getApiV1UniversityPositionList: build.query<
      GetApiV1UniversityPositionListApiResponse,
      GetApiV1UniversityPositionListApiArg
    >({
      query: (queryArg) => ({
...
export type GetApiV1DepartmentGetByIdApiResponse =
  /** status 200 Success */ DepartmentGetResponseDto;
export type GetApiV1DepartmentGetByIdApiArg = {
  id: string;
};
export type GetApiV1DepartmentListApiResponse =
  /** status 200 Success */ DepartmentListResponseDtoRead;
...
export type PostApiV1DepartmentCreateApiResponse =
  /** status 200 Success */ DepartmentCreateResponseDto;
export type PostApiV1DepartmentCreateApiArg = {
  name: string;
  shortName: string;
  facultyId?: string;
};
export type DeleteApiV1DepartmentDeleteApiResponse =
...
export type GetApiV1FacultyGetByIdApiResponse =
  /** status 200 Success */ FacultyGetResponseDto;
export type GetApiV1FacultyGetByIdApiArg = {
  id: string;
};
export type GetApiV1FacultyListApiResponse =
  /** status 200 Success */ FacultyListResponseDtoRead;
...
export type PostApiV1FacultyCreateApiResponse =
  /** status 200 Success */ FacultyCreateResponseDto;
export type PostApiV1FacultyCreateApiArg = {
  name: string;
  shortName: string;
  universityId?: string;
};
export type DeleteApiV1FacultyDeleteApiResponse =
  /** status 200 Success */ void;
export type DeleteApiV1FacultyDeleteApiArg = {
  facultyDeleteRequestDto: FacultyDeleteRequestDto;
};
export type GetApiV1GroupGetByIdApiResponse =
  /** status 200 Success */ GroupGetResponseDto;
export type GetApiV1GroupGetByIdApiArg = {
  id: string;
};
export type GetApiV1GroupListApiResponse =
  /** status 200 Success */ GroupListResponseDtoRead;
...
export type PostApiV1GroupCreateApiResponse =
  /** status 200 Success */ GroupCreateResponseDto;
...
export type PostApiV1IdentityLoginApiResponse =
  /** status 200 Success */ LoginResponseDto;
export type PostApiV1IdentityLoginApiArg = {
  loginRequestDto: LoginRequestDto;
};
export type PostApiV1IdentityRegisterApiResponse =
  /** status 200 Success */ void;
...
export type GetApiV1IdentityInfoApiResponse =
  /** status 200 Success */ InfoResponseDto;
export type GetApiV1IdentityInfoApiArg = void;
export type GetApiV1SpecialtyGetByIdApiResponse =
  /** status 200 Success */ SpecialtyGetResponseDto;
export type GetApiV1SpecialtyGetByIdApiArg = {
  id: string;
};
export type GetApiV1SpecialtyListApiResponse =
  /** status 200 Success */ SpecialtyListResponseDtoRead;
...
export type PostApiV1SpecialtyCreateApiResponse =
  /** status 200 Success */ SpecialtyCreateResponseDto;
...
export type DeleteApiV1SpecialtyDeleteApiResponse =
  /** status 200 Success */ void;
export type DeleteApiV1SpecialtyDeleteApiArg = {
  specialtyDeleteRequestDto: SpecialtyDeleteRequestDto;
};
export type GetApiV1UniversityGetByIdApiResponse =
  /** status 200 Success */ UniversityGetResponseDto;
export type GetApiV1UniversityGetByIdApiArg = {
  id: string;
};
export type GetApiV1UniversityListApiResponse =
  /** status 200 Success */ UniversityListResponseDtoRead;
...
export type PostApiV1UniversityCreateApiResponse =
  /** status 200 Success */ UniversityCreateResponseDto;
export type PostApiV1UniversityCreateApiArg = {
  name: string;
  shortName: string;
};
export type DeleteApiV1UniversityDeleteApiResponse =
  /** status 200 Success */ void;
export type DeleteApiV1UniversityDeleteApiArg = {
  universityDeleteRequestDto: UniversityDeleteRequestDto;
};
export type GetApiV1UniversityPositionGetByIdApiResponse =
  /** status 200 Success */ UniversityPositionGetResponseDto;
export type GetApiV1UniversityPositionGetByIdApiArg = {
  id: string;
};
export type GetApiV1UniversityPositionListApiResponse =
  /** status 200 Success */ UniversityPositionListResponseDtoRead;
