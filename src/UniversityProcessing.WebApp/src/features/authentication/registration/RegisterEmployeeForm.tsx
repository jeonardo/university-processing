...
import { useGetApiV1RegistrationGetAvailableUniversityPositionsQuery, useLazyGetApiV1RegistrationGetAvailableUniversitiesQuery, usePostApiV1RegistrationRegisterEmployeeMutation } from 'src/api/backendApi';
