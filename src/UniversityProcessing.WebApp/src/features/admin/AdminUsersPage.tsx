...
import {
    ...
    MenuItem, Chip, Switch, FormControlLabel, Tooltip, Avatar, Grid,
    Snackbar, Alert, CircularProgress, InputAdornment, Badge
} from '@mui/material';
import {
    Add as AddIcon,
    Edit as EditIcon,
...
const getRoleLabel = (role: UserRole) => {
    switch (role) {
        ...
        case 'deanery': return 'Деканат';
        case 'departmentHead': return 'Руководитель кафедры';
        case 'supervisor': return 'Научный руководитель';
        case 'student': return 'Студент';
        case 'commission': return 'Член ГЭК';
        default: return role;
    }
};
...
const getRoleColor = (role: UserRole) => {
    switch (role) {
        ...
        case 'deanery': return 'primary';
        case 'departmentHead': return 'secondary';
