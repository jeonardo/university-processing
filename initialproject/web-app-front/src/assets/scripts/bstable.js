...
<!--                </button>-->
                <button id="bEdit" class="me-2 btn btn-lg text-dark edit-button" style="padding: 0; height: 10px">
                    <i class="icon-pencil"></i>
                </button>
                <button  id="bDel" class="btn btn-lg text-dark delete-button">
...
<!--                </button>-->
   ...
   */
  init() {
    this.table.find('thead tr').append('<th name="bstable-actions" scope="col">' + this.options.advanced.columnLabel + '</th>');  // Append column to header
